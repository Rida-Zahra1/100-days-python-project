...
class CurrencyConverter(tk.Tk):
    ...
    def frame(self):
        ...
        self.label_frame = tk.LabelFrame(self.main_frame,font=('Arial',15),text='Currency Converter',width=80)
        ...
        tk.Button(self.label_frame,text='Enter',command=self.calculate,font=('Arial',10),bg='black',fg='white').grid(row=4,column=1,ipadx=10)
